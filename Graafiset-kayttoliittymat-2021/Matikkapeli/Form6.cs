    ...
    public partial class Form6 : Form
    {
        ...
        private void timer4_Tick(object sender, EventArgs e)
        {
            if (TarkistaVastaukset())
            {
                ...
                using TextWriter txt = new StreamWriter("C:\\Users\\puukk\\graafiset-kayttoliittymat-2021\\15 Matikkapeli\\TuloksetKerto.txt", true);
                txt.Write("\n" + aikaNimi);
                txt.Close();
        ...
        {
            numero1 = satunnainen.Next(1, 11);
            numero2 = satunnainen.Next(1, 11);
            numero3 = satunnainen.Next(1, 11);
            numero4 = satunnainen.Next(1, 11);
            numero5 = satunnainen.Next(1, 11);
            numero6 = satunnainen.Next(1, 11);
            numero7 = satunnainen.Next(1, 11);
            numero8 = satunnainen.Next(1, 11);
            numero9 = satunnainen.Next(1, 11);
            numero10 = satunnainen.Next(1, 11);
