    ...
    public partial class Form4 : Form
    {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            if (TarkistaVastaukset())
            {
                ...
                using TextWriter txt = new StreamWriter("C:\\Users\\puukk\\graafiset-kayttoliittymat-2021\\15 Matikkapeli\\TuloksetVahennys.txt", true);
                txt.Write("\n" + aikaNimi);
                txt.Close();
        ...
        {
            numero1 = satunnainen.Next(51, 101);
            numero2 = satunnainen.Next(1, 51);
            numero3 = satunnainen.Next(51, 101);
            numero4 = satunnainen.Next(1, 51);
            numero5 = satunnainen.Next(51, 101);
            numero6 = satunnainen.Next(1, 51);
            numero7 = satunnainen.Next(51, 101);
            numero8 = satunnainen.Next(1, 51);
            numero9 = satunnainen.Next(51, 101);
