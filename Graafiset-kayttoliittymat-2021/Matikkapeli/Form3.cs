...
namespace _15_Matikkapeli
{
    public partial class Form3 : Form
    {
        ...
        private void nimiButton_Click(object sender, EventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (TarkistaVastaukset())
            {
                ...
                using TextWriter txt = new StreamWriter("C:\\Users\\puukk\\graafiset-kayttoliittymat-2021\\15 Matikkapeli\\TuloksetYhteen.txt", true);
                txt.Write("\n" + aikaNimi);
                txt.Close();
            ...
            else
            {
                ...
                MessageBox.Show("Aika loppui ennen kuin kerkesit vastata kaikkiin kysymyksiin. Oikeat vastaukset on lisätty vastaus kenttään.", "Huom!");
        ...
        {
            numero1 = satunnainen.Next(1,51);
            numero2 = satunnainen.Next(1, 51);
            numero3 = satunnainen.Next(1, 51);
            numero4 = satunnainen.Next(1, 51);
            numero5 = satunnainen.Next(1, 51);
            numero6 = satunnainen.Next(1, 51);
            numero7 = satunnainen.Next(1, 51);
            numero8 = satunnainen.Next(1, 51);
            numero9 = satunnainen.Next(1, 51);
            numero10 = satunnainen.Next(1, 51);
